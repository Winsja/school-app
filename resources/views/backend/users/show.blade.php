...
<div class="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-600 dark:border-gray-700">
    <h5 class="mb-6 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Informacje o koncie</h5>

    <p class="mb-3 font-normal text-gray-100 ">Imie i nazwisko: {{ $users->name}}</p>
    <p class="mb-3 font-normal text-gray-100">Adres e-mail: {{ $users->email}}</p>
    <p class="mb-3 font-normal text-gray-100">Rola konta: {{ $users->role}}</p>
    <!-- TO DO -->
